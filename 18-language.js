...
const DICTIONARIES = {
  ru: {
    ...
    signInRequiredHint: 'Google разлогинил браузер. Открой ClassDash → «Sign In to Google Classroom…» в строке меню.',
  ...
  en: {
    ...
    signInRequiredHint: 'Google signed the browser out. Open ClassDash → "Sign In to Google Classroom…" in the menu bar.',
